...
```
curl "https://nubesgen.com/demo.tgz?iactool=TERRAFORM&region=westeurope&application=APP_SERVICE.standard&runtime=SPRING&database=POSTGRESQL.basic&gitops=true" | tar -xzvf -
```
